...
const Autores = () => {
    ...
    return (
        <>
            <h2 style={{color:'#5499C7'}}>Autores Favoritos</h2>
                ...
                <tbody>
                    {autores.map((autor, index) => (
                        <tr key={index}>
                            ...
                            <td>
                                <Link className="btn btn-primary"to={`/autores/${autor._id}`}>
                                    Detalle
                                </Link>
                                <Link className="btn btn-success ms-2" to={`/autores/${autor._id}/editar`}>
                                    Editar
                                </Link>
                                <DeleteButton
                                    id_autor={autor._id}
